...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project, darkMode }) => {
    return (
        <div className="flex flex-col w-[27%] items-center border border-customPinkLight bg-customPinkLight text-customPurple rounded-md">
            <img src={project.src} width={400} className="border border-customPinkLight rounded-md" />
            <div className="p-4 space-y-2">
                <h3 className="text-3xl font-bold">{project.name}</h3>
                <h4 className="text-xl font-semibold">{project.title}</h4>
                <p className="text-sm-md">{project.description}</p>
                <h4 className="text-xl font-semibold border-b border-customPurple pb-2">Technologies</h4>
                ...
                <div className="">
                    <h4 className="text-xl font-semibold border-b border-customPurple pb-2">Demo Account</h4>
